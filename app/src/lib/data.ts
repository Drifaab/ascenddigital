export const heroStats = [
  { value: '50+', label: 'Projekt', subtext: 'Avslutade' },
  { value: '95%', label: 'Nöjda kunder', subtext: 'Rekommenderar oss' },
  { value: '450%', label: 'Genomsnittlig ROAS', subtext: 'Över alla kanaler' },
];
...
export const services = [
  {
    ...
    color: 'orange',
    features: ['Sökordsanalys', 'On-page SEO', 'Google Ads', 'Local SEO'],
  },
  {
    slug: 'paid-social',
    title: 'Paid Social',
    ...
    color: 'maize',
    features: ['Meta Ads', 'TikTok Ads', 'LinkedIn Ads', 'Influencer marketing'],
  },
  {
    ...
    color: 'gray',
    features: ['React/Next.js', 'E-handel', 'API-utveckling', 'Cloud hosting'],
  },
  {
    slug: 'agile-business',
    ...
    color: 'orange',
    features: ['Strategi', 'KPI-tracking', 'A/B-testning', 'Tillväxtoptimering'],
  },
];

export const caseStudies = [
  {
    slug: 'nordic-fulfillment',
